...
The adjacent `(B4)` alpha-constant definition is context/dependency for the alpha branches, not part of the normalized mass-formula body in this record.
...
- `(B4)` radical degree, denominator scope, bracket-square scope, and trailing `√2η` grouping still require a dedicated alpha-constant check.
